...
function onMessage(message) {
    return __awaiter(this, void 0, void 0, function () {
        var content, leaderboardKey, msg, err_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!content.startsWith("!lb"))
                        return [2 /*return*/];
                    leaderboardKey = entities_1.KeyFormat[content.split(" ")[1]];
                    // Verifies if the user input is a leaderboard
                    // if undefined, we notify the user
                    if (!leaderboardKey) {
                        message.reply(leaderboard_1.listAcceptedLeaderboards());
                        return [2 /*return*/];
                    }
                    ...
                    if (leaderboardKey === "TEAMS") {
                        message.reply(leaderboard_1.getTeamLeaderboard());
                        return [2 /*return*/];
                    }
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, leaderboard_1.getSingularLeaderboard(leaderboardKey)];
                case 2:
                    msg = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    err_1 = _a.sent();
                    msg =
                        err_1 instanceof BadCredentialsError_1.BadCredentialsError
